/*:
 * @plugindesc C47_SeamlessMap depends on this plugin.
 *
 * @author chyj4747 & Lanza Schneider
 *
 * @help 
 * Put this plugin on top of C47_SeamlessMap.
 */
var PIXI;
(function (PIXI) {
    var tilemap2;
    (function (tilemap2) {
        ...
        tilemap2.CanvasTileRenderer = CanvasTileRenderer;
        PIXI.CanvasRenderer.registerPlugin('tilemap2', CanvasTileRenderer);
    })(tilemap2 = PIXI.tilemap2 || (PIXI.tilemap2 = {}));
})(PIXI || (PIXI = {}));
    ...
    (function (tilemap2) {
        var CompositeRectTileLayer = (function (_super) {
            ...
            CompositeRectTileLayer.prototype.setBitmaps = function (bitmaps) {
                ...
                for (i = len1; i < len2; i++) {
                    this.addChild(new tilemap2.RectTileLayer(this.zIndex, bitmaps.slice(i * texPerChild, (i + 1) * texPerChild)));
                }
            };
            ...
            CompositeRectTileLayer.prototype.addFrame = function (texture_, x, y, animX, animY) {
                ...
                if (typeof texture_ === "number") {
                    ...
                    if (!layer) {
                        ...
                        if (!layer) {
                            children.push(layer = new tilemap2.RectTileLayer(this.zIndex, texture));
                            ind = 0;
                        }
                    }
                }
            ...
            CompositeRectTileLayer.prototype.renderCanvas = function (renderer) {
                if (!renderer.plugins.tilemap2.dontUseTransform) {
            ...
            CompositeRectTileLayer.prototype.renderWebGL = function (renderer) {
                var gl = renderer.gl;
                var shader = renderer.plugins.tilemap2.getShader(this.useSquare);
                renderer.setObjectRenderer(renderer.plugins.tilemap2);
                ...
                var af = shader.uniforms.animationFrame = renderer.plugins.tilemap2.tileAnim;
                var layers = this.children;
                for (var i = 0; i < layers.length; i++)
                {
        ...
        tilemap2.CompositeRectTileLayer = CompositeRectTileLayer;
    })(tilemap2 = PIXI.tilemap2 || (PIXI.tilemap2 = {}));
})(PIXI || (PIXI = {}));
var PIXI;
(function (PIXI) {
...
(function (PIXI) {
    ...
    (function (tilemap2) {
        var RectTileLayer = (function (_super) {
            ...
            RectTileLayer.prototype.renderCanvas = function (renderer) {
                ...
                for (var i = 0, n = points.length; i < n; i += 9) {
                    ...
                    var w = points[i + 4];
                    var h = points[i + 5];
                    x1 += points[i + 6] * renderer.plugins.tilemap2.tileAnim[0];
                    y1 += points[i + 7] * renderer.plugins.tilemap2.tileAnim[1];
        ...
        tilemap2.RectTileLayer = RectTileLayer;
    })(tilemap2 = PIXI.tilemap2 || (PIXI.tilemap2 = {}));
})(PIXI || (PIXI = {}));
var PIXI;
(function (PIXI) {
    ...
    (function (tilemap2) {
        ...
        var TilemapShader = (function (_super) {
            ...
            function TilemapShader(gl, maxTextures, shaderVert, shaderFrag) {
                ...
                tilemap2.shaderGenerator.fillSamplers(_this, _this.maxTextures);
                return _this;
            }
            return TilemapShader;
        }(PIXI.Shader));
        tilemap2.TilemapShader = TilemapShader;
        var RectTileShader = (function (_super) {
            __extends(RectTileShader, _super);
            function RectTileShader(gl, maxTextures) {
                var _this = _super.call(this, gl, maxTextures, rectShaderVert, tilemap2.shaderGenerator.generateFragmentSrc(maxTextures, rectShaderFrag)) || this;
                _this.vertSize = 11;
                _this.vertPerQuad = 4;
        ...
        tilemap2.RectTileShader = RectTileShader;
    })(tilemap2 = PIXI.tilemap2 || (PIXI.tilemap2 = {}));
})(PIXI || (PIXI = {}));
var PIXI;
(function (PIXI) {
    ...
    (function (tilemap2) {
        ...
        })(shaderGenerator = tilemap2.shaderGenerator || (tilemap2.shaderGenerator = {}));
    })(tilemap2 = PIXI.tilemap2 || (PIXI.tilemap2 = {}));
})(PIXI || (PIXI = {}));
var PIXI;
(function (PIXI) {
    ...
    (function (tilemap2) {
        ...
        var SquareTileShader = (function (_super) {
            ...
            function SquareTileShader(gl, maxTextures) {
                var _this = _super.call(this, gl, maxTextures, squareShaderVert, tilemap2.shaderGenerator.generateFragmentSrc(maxTextures, squareShaderFrag)) || this;
                _this.vertSize = 8;
                _this.vertPerQuad = 1;
                _this.stride = _this.vertSize * 4;
                _this.maxTextures = maxTextures;
        ...
        }(tilemap2.TilemapShader));
        tilemap2.SquareTileShader = SquareTileShader;
    })(tilemap2 = PIXI.tilemap2 || (PIXI.tilemap2 = {}));
})(PIXI || (PIXI = {}));
var PIXI;
(function (PIXI) {
    ...
    (function (tilemap2) {
        ...
        var TileRenderer = (function (_super) {
            ...
            TileRenderer.prototype.onContextChange = function () {
                ...
                this.rectShader = new tilemap2.RectTileShader(gl, maxTextures);
                this.squareShader = new tilemap2.SquareTileShader(gl, maxTextures);
        ...
        tilemap2.TileRenderer = TileRenderer;
        PIXI.WebGLRenderer.registerPlugin('tilemap2', TileRenderer);
    })(tilemap2 = PIXI.tilemap2 || (PIXI.tilemap2 = {}));
})(PIXI || (PIXI = {}));
var PIXI;
(function (PIXI) {
    ...
    (function (tilemap2_1) {
        var ZLayer = (function (_super) {
            ...
            function ZLayer(tilemap2, zIndex) {
                var _this = _super.call(this) || this;
                _this._lastAnimationFrame = -1;
                _this.tilemap2 = tilemap2;
                _this.z = zIndex;
                return _this;
            }
            ...
            ZLayer.prototype.cacheIfDirty = function () {
                ...
                if (!buf) {
                    ...
                    tempRender.plugins.tilemap2.dontUseTransform = true;
                }
                if (buf.width != tilemap2._layerWidth ||
                    buf.height != tilemap2._layerHeight) {
                    buf.width = tilemap2._layerWidth;
                    buf.height = tilemap2._layerHeight;
                    modified = true;
                }
                var i;
                if (!modified) {
                    for (i = 0; i < layers.length; i++) {
                        if (layers[i].isModified(this._lastAnimationFrame != tilemap2.animationFrame)) {
                            modified = true;
                            break;
                        }
                    }
                }
                this._lastAnimationFrame = tilemap2.animationFrame;
                if (modified) {
                    if (tilemap2._hackRenderer) {
                        tilemap2._hackRenderer(tempRender);
                    }
        ...
        tilemap2_1.ZLayer = ZLayer;
    })(tilemap2 = PIXI.tilemap2 || (PIXI.tilemap2 = {}));
})(PIXI || (PIXI = {}));
//# sourceMappingURL=pixi-tilemap2.js.map